...
| Voter Turnout/How Voted by county and various demographic variables (too big for Github) | [IPUMS](https://cps.ipums.org/cps/index.shtml) | Once you get a (free) account, this site allows user crafted extracts from the census CPS survey |
